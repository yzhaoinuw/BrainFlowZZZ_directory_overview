...
# Weekly Job Error Log

Errors from the automated weekly BrainFlowZZZ update job. Most recent entry at top.  
Check `~/logs/brainflow_update_<jobid>.out` on the cluster for full output.
